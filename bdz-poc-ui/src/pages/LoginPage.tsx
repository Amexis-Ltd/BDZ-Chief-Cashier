...
import { cashierLoginSuccess } from '../store/features/auth/authSlice';
...
const LoginPage: React.FC = () => {
  ...
  const from = (location.state as { from?: { pathname: string } })?.from?.pathname || '/nomenclatures/trains';
  ...
  const handleLogin = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (username.trim() && password.trim()) {
      ...
      // Navigate to the page they tried to visit or trains list
